 ...
 */
public class ArchiveVisitTaskFragment extends Fragment implements SwipeRefreshLayout.OnRefreshListener {
    ...
    public ArchiveVisitTaskFragment() {
    ...
    private void getVisitTaskList() {
        ...
        Call<DoctorTaskListBean> taskCall = apiInterface.doGetArchiveTypeTaskList(userID,"4",page);
