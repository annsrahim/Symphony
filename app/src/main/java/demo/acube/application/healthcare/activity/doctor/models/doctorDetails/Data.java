...
public class Data {
    ...
    @SerializedName("eula_agreed_at")
    @Expose
    private String eulaAgreedAt;
    ...
    public String getEulaAgreedAt() {
        return eulaAgreedAt;
    }

    public void setEulaAgreedAt(String eulaAgreedAt) {
        this.eulaAgreedAt = eulaAgreedAt;
    }
