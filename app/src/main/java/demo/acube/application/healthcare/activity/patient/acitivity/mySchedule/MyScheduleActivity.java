...
public class MyScheduleActivity extends AppCompatActivity implements OnDateSelectedListener {
    ...
    public void showScheduleDetail(int pos)
    {
        ...
        ScheduleDetailFragment scheduleDetailFragment = ScheduleDetailFragment.newInsatnce();
    ...
    private void getPatientSchedulesByMonthYear(int month,int year)
    {
       ...
       // progressDialog = LoadingDialog.show(this,"Getting schedules");
        ...
        scheduleCall.enqueue(new Callback<PatientScheduleBean>() {
            ...
            public void onFailure(Call<PatientScheduleBean> call, Throwable t) {
                   //progressDialog.dismiss();
                Utils.showToast(MyScheduleActivity.this,"Unable to fetch schedules "+t.getLocalizedMessage());
            }
        });
    ...
    private void initToolbar() {
        ...
        tvToolbarBack.setTextColor(ContextCompat.getColor(this,R.color.White));
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        inflater.inflate(R.menu.menu_plus_icon, menu);
        return true;
    }
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if(item.getItemId()==R.id.menu_plus_icon)
        {
    ...
    private void goToCreateAppointment()
    {
        ...
        globalApplication.setScheduledDate(materialCalendarView.getSelectedDate());
    ...
    public void showFilterTypes(View view) {
        FragmentTransaction ft = getSupportFragmentManager().beginTransaction();
        CalendarFilterTypeFragment calendarFilterTypeFragment = CalendarFilterTypeFragment.newInsatnce();
