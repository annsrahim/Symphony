...
public class ArchiveTaskListAdapter extends RecyclerView.Adapter<ArchiveTaskListAdapter.MyViewHolder> {
    ...
    @Override
    public ArchiveTaskListAdapter.MyViewHolder onCreateViewHolder(ViewGroup parent, final int viewType) {
    ...
    public ArchiveTaskListAdapter(List<Datum> taskList, Context context, ITaskListClickListener listClickListener)
    {
    ...
    @Override
    public void onBindViewHolder(ArchiveTaskListAdapter.MyViewHolder holder, int position) {
