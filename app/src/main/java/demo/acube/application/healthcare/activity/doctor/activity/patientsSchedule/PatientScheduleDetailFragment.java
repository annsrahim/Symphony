...
public class PatientScheduleDetailFragment extends DialogFragment implements View.OnClickListener
{
    static PatientScheduleDetailFragment newInsatnce()
    {
        return new PatientScheduleDetailFragment();
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        isAppointmentSelected = ((PatinetScheduleActivity)getActivity()).isAppointmentSelected;
        selectedPosition = ((PatinetScheduleActivity)getActivity()).selectedPosition;
        selectedPatientSchedulesList = ((PatinetScheduleActivity)getActivity()).selectedPatientSchedulesList;
        userID = ((PatinetScheduleActivity)getActivity()).globalApplication.getUserId();
    ...
    private void appointmentDetail()
    {
        ...
        if(userID==appointment.getCreator().getUserId())
            ...
            tvTaskCreatedBY.setText(String.format("Created by %s", appointment.getCreator().getName()));
             ...
             CalendarDay selectedCalendarDay = ((PatinetScheduleActivity)getActivity()).materialCalendarView.getSelectedDate();
        ...
        if(appointment.getNotes()!=null && !appointment.getNotes().equals(""))
    ...
    private void initToolbar() {
        ...
        tvToolbarTitle.setTextColor(ContextCompat.getColor(getActivity(),R.color.toolbar_blue));
        tvToolbarBack.setTextColor(ContextCompat.getColor(getActivity(),R.color.toolbar_blue));
