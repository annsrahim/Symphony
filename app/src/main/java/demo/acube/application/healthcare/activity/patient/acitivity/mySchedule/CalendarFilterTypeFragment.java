...
public class CalendarFilterTypeFragment extends DialogFragment implements View.OnClickListener
{
    public static CalendarFilterTypeFragment newInsatnce()
    {
        return new CalendarFilterTypeFragment();
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        initToolbar();
        initUI();
        enabledTypeArray = ((MyScheduleActivity)getActivity()).enabledTypesArray;
        checkMarkAssign();
    ...
    private void initToolbar()
    {
        ...
        tvToolbarDone.setTextColor(ContextCompat.getColor(getActivity(),R.color.White));
    ...
    private void done()
    {
        ((MyScheduleActivity)getActivity()).enabledTypesArray = enabledTypeArray;
        ((MyScheduleActivity)getActivity()).updateFilterInCalendars();
        dismiss();
    }
