...
public class DoctorUnitSelectDialogFragment extends DialogFragment implements View.OnClickListener {
    String[] mDosageInfo = new String[3];
    String[] unit_array;
    static DoctorUnitSelectDialogFragment newInstance()
    {
        return new DoctorUnitSelectDialogFragment();
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        mDosageInfo = ((DoctorMedicationReminderActivity)getActivity()).mDosageInfo;
        initToolbar();
        initUI();
    ...
    {
        ((DoctorMedicationReminderActivity)getActivity()).mDosageInfo = mDosageInfo;
        DoctorDosageSelectDialogFragment parentFrag = ((DoctorDosageSelectDialogFragment)this.getParentFragment());
