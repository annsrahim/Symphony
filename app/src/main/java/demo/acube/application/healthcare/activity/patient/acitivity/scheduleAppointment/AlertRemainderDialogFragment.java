...
public class AlertRemainderDialogFragment extends DialogFragment implements View.OnClickListener{
    static AlertRemainderDialogFragment newInstance() {
        AlertRemainderDialogFragment f = new AlertRemainderDialogFragment();
        return f;
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        alertNotifyType =  ((MedicationRemainderActivity)getActivity()).mAlertNotifyType;
        initToolbar();
        initUI();
    ...
    public void onClick(View v)
    {
        switch (v.getId())
        {
            case R.id.rl_alert_none:
                ((MedicationRemainderActivity)getActivity()).mAlertNotifyType = -1;
                ((MedicationRemainderActivity)getActivity()).updateAlertTime();
                dismiss();
                break;
            case R.id.rl_alert_at_event_time:
                ((MedicationRemainderActivity)getActivity()).mAlertNotifyType = 0;
                ((MedicationRemainderActivity)getActivity()).updateAlertTime();
                dismiss();
                break;
            ...
            case R.id.rl_alert_10_min:
                ((MedicationRemainderActivity)getActivity()).mAlertNotifyType = 2;
                ((MedicationRemainderActivity)getActivity()).updateAlertTime();
                dismiss();
                break;
