 ...
 */
public class HomeChatTaskFragment extends Fragment implements SwipeRefreshLayout.OnRefreshListener {
    ...
    private void getChatTaskList() {
        ...
        Call<DoctorTaskListBean> taskCall = apiInterface.doGetDocotorCallTaskList(userID,1,page);
